            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <form role="form" method="POST" action="{{ url('/paciente/'.$paciente->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="apellido" value="{{old('apellido',$paciente->apellido)}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Alergico
                                                a</label>
                                            <input class="form-control" type="text" name="alergico_a" value="{{old('alergico_a',$paciente->alergico_a)}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" aria-label="Default select example" name="club">
                                                ...
                                                @foreach ($data as $item)
                                                    <option  {{ $item->id === $paciente->idClub ? 'selected' : '' }}  value="{{ $item->id }}" >{{$item->nombre}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
